...
CREATE VIEW Veiculos_Reservados AS
SELECT * FROM Veiculo
WHERE placa IN (SELECT placa FROM Aluguel WHERE reserva IS NOT NULL AND retirada IS NULL);

CREATE VIEW Veiculos_Alugados AS
SELECT * FROM Veiculo
WHERE placa IN (SELECT placa FROM Aluguel WHERE retirada IS NOT NULL AND devolucao IS NULL);
